...
export default function AdminUsersPage() {
  ...
  async function generateResetLink(userId: string) {
    try {
      ...
      const url = window.location.origin + "/reset-password?phone=" + encodeURIComponent(data.phone);
      await navigator.clipboard.writeText(`لینک بازیابی: ${url}\nکد یک‌بارمصرف: ${data.code}`);
      toast.success("لینک و کد یک‌بارمصرف جداگانه در حافظه کپی شدند.");
